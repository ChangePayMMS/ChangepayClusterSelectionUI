...
class CircleTileWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final double tileWidth = 149.5 / 375 * MediaQuery.of(context).size.width;
    final double tileHeight = 163.8 / 375 * MediaQuery.of(context).size.width;
    return SizedBox(
      width: tileWidth,
      height: tileHeight,
                        ...
                        child: CachedNetworkImage(
                          ...
                          errorWidget: (context, url, error) => Container(
                              color: CustomTheme.of(context)
                                  ...
                                  .placeHolderColor,
                              child: Image.asset(
                                'assets/circle_tile_placeholder.png',
                                fit: BoxFit.contain,
                              )),
                        ),
                      ),
